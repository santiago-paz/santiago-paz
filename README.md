...
| Project | What it is |
| :--- | :--- |
| **[Contract Lens](https://github.com/santiago-paz/contract-lens)** · [▶ live demo](https://trycontractlens.com) | Multi-tenant SaaS for small law firms. Upload a PDF or DOCX and an LLM pipeline extracts parties, dates, clauses and renewal terms into a typed schema, then drives a task and alert system so deadlines don't get missed. Next.js 16 · Prisma · AI SDK v6 · AES-256-GCM · EN/DE |
